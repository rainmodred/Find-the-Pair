...
var Cards = /*#__PURE__*/function () {
  function Cards() {
    ...
    this.cardsArray = ['moon', 'moon', 'goat', 'rat', 'summer', 'winter', 'rabbit', 'sigma', 'new-moon', 'new-moon', 'goat', 'rat', 'summer', 'winter', 'rabbit', 'sigma'];
  }
...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    key: "addClickedCardName",
    value: function addClickedCardName(cardName) {
      this.clickedCardsArray.push(cardName);
    }
  }, {
    key: "compareCards",
    value: function compareCards(card1, card2) {
...
var _Cards = _interopRequireDefault(require("./src/js/Cards"));

var _Game = _interopRequireDefault(require("./src/js/Game"));
...
function createCards() {
  cards.cardsArray.forEach(function (cardName) {
...
function showGameOver(status) {
  var domSt = document.querySelector(".".concat(status));
...
function handleCardClick(card) {
  card.addEventListener('click', function () {
    if (_toConsumableArray(card.classList).indexOf('flipped') === -1 || clickedCards.length > 1) {
      return;
    }
...
function compareCards() {
  game.updateMoves();
  var compare = game.compareCards.apply(game, _toConsumableArray(clickedCards));
...
var game = new _Game.default(LIVES);
var cards = new _Cards.default();
...
var clickedCards = [];
startNewGame(LIVES);
},{"./src/js/Cards":"src/js/Cards.js","./src/js/Game":"src/js/Game.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
